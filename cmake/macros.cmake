...
FUNCTION( CALL_ADD_TEST EXEFILE )
    ...
    ELSE()
        ...
        RETURN()
    ENDIF()
    SET_TESTS_PROPERTIES( ${TESTNAME} PROPERTIES FAIL_REGULAR_EXPRESSION "${TEST_FAIL_REGULAR_EXPRESSION}" PROCESSORS ${TOT_PROCS} PROCESSOR_AFFINITY TRUE )
...
FUNCTION( ADD_${PROJ}_EXAMPLE EXEFILE )
    ...
    IF ( NOT TEST_RESOURCES )
        SET( TEST_RESOURCES ${EXEFILE} ${TEST_ARGS} )
    ENDIF()
    SET_TESTS_PROPERTIES( ${TESTNAME} PROPERTIES RESOURCE_LOCK ${TEST_RESOURCES} )
ENDFUNCTION()
