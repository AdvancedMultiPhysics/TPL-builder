...
MACRO( PARSE_TEST_ARGUMENTS )
    ...
    SET( optionalArgs WEEKLY TESTBUILDER GPU RUN_SERIAL EXAMPLE MATLAB )
...
FUNCTION( CALL_ADD_TEST EXEFILE )
    ...
    ELSEIF ( USE_MPI OR USE_EXT_MPI )
        IF ( TEST_TESTBUILDER )
            ADD_TEST( NAME ${TESTNAME} COMMAND ${MPIEXEC} ${MPIEXEC_NUMPROC_FLAG} ${TEST_PROCS} $<TARGET_FILE:${TB_TARGET}> ${EXEFILE} ${TEST_ARGS} )
        ELSE()
    ...
    # Add resource locks
    IF ( NOT RESOURCES )
        SET( RESOURCES ${EXEFILE} ${TEST_ARGS} )
    ENDIF()
