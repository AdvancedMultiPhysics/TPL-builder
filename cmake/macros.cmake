...
FUNCTION( CREATE_MATLAB_WRAPPER )
    IF ( NOT USING_MSVC )
        ...
        FILE( WRITE "${CMAKE_CURRENT_BINARY_DIR}/tmp/matlab-gui" "LD_PRELOAD=\"${tmp_libs}\" MATLABPATH=\"${tmp_path}\" \"${MATLAB_EXE2}\" -singleCompThread \"$@\"\n")
        FILE( WRITE "${CMAKE_CURRENT_BINARY_DIR}/tmp/matlab-cmd" "LD_PRELOAD=\"${tmp_libs}\" MATLABPATH=\"${tmp_path}\" \"${MATLAB_EXE2}\" -singleCompThread -nodisplay -nojvm \"$@\"\n")
        FILE( COPY "${CMAKE_CURRENT_BINARY_DIR}/tmp/matlab-gui" DESTINATION "${${PROJ}_INSTALL_DIR}/mex"
            FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE )
        FILE( COPY "${CMAKE_CURRENT_BINARY_DIR}/tmp/matlab-cmd" DESTINATION "${${PROJ}_INSTALL_DIR}/mex"
            FILE_PERMISSIONS OWNER_READ OWNER_WRITE OWNER_EXECUTE GROUP_READ GROUP_EXECUTE WORLD_READ WORLD_EXECUTE )
        SET( MATLAB_EXE "${${PROJ}_INSTALL_DIR}/mex/matlab-cmd" CACHE INTERNAL "" )
    ENDIF()
ENDFUNCTION()
