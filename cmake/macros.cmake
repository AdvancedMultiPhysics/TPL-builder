...
FUNCTION( CALL_ADD_TEST EXEFILE )
    ...
    SET( GPU_TEST ${CALL_ADD_TEST_GPU} )
    ...
    # MESSAGE( "CALL_ADD_TEST( ${EXEFILE} TESTNAME ${TESTNAME} PROCS ${PROCS} WEEKLY ${WEEKLY} TESTBUILDER ${TESTBUILDER} RESOURCES ${RESOURCES} GPU ${GPU} DEPENDS ${TESTDEPENDS} ARGS ${ARGS}" )
ENDFUNCTION()
