...
MACRO( TARGET_LINK_EXTERNAL_LIBRARIES TARGET_NAME )
    ...
    IF ( NOT DEFINED MACROS_FORTRAN_LINK_LIBRARIES )
        ...
        SET( MACROS_FORTRAN_LINK_DIRECTORIES )
        IF ( CMAKE_Fortran_COMPILER AND CMAKE_Fortran_IMPLICIT_LINK_LIBRARIES )
            ...
            IF ( testFortranImplicit )
                ...
                SET( MACROS_FORTRAN_LINK_DIRECTORIES ${CMAKE_Fortran_IMPLICIT_LINK_DIRECTORIES} )
            ENDIF()
        ENDIF()
    ENDIF()
    # Include CMake implicit libraries
    SET( CMAKE_IMPLICIT_LINK_LIBRARIES ${CMAKE_HIP_IMPLICIT_LINK_LIBRARIES} ${CMAKE_CUDA_IMPLICIT_LINK_LIBRARIES}
        ${CMAKE_C_IMPLICIT_LINK_LIBRARIES} ${CMAKE_CXX_IMPLICIT_LINK_LIBRARIES} ${MACROS_FORTRAN_LINK_LIBRARIES} )
    SET( CMAKE_IMPLICIT_LINK_DIRECTORIES ${CMAKE_HIP_IMPLICIT_LINK_DIRECTORIES} ${CMAKE_CUDA_IMPLICIT_LINK_DIRECTORIES}
        ${CMAKE_C_IMPLICIT_LINK_DIRECTORIES} ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES} ${MACROS_FORTRAN_LINK_DIRECTORIES} )
