...
FUNCTION( CONFIGURE_TIMER DEFAULT_USE_TIMER NULL_TIMER_DIR QUIET )
    ...
    ELSE()
        ...
        # Write MemoryApp.h
        FILE(WRITE  "${NULL_TIMER_DIR}/ProfilerApp.h" "class MemoryApp final {\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "public:\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "   struct MemoryStats {\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "       size_t bytes_new, bytes_delete, N_new, N_delete, tot_bytes_used, system_memory, stack_used, stack_size;\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "       MemoryStats() { memset(this,0,sizeof(MemoryStats); }\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "   };\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "   static inline void print( std::ostream& ) {}\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "   static inline size_t getMemoryUsage() { return 0; }\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "   static inline size_t getTotalMemoryUsage() { return 0; }\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "   static inline size_t getSystemMemory() { return 0; }\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "   static inline MemoryStats getMemoryStats() { return MemoryStats(); }\n" )
        FILE(APPEND "${NULL_TIMER_DIR}/ProfilerApp.h" "};\n" )
