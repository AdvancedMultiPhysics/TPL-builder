...
IF ( USE_OPENMP )
    FILE( APPEND "${TPLs_HEADER}" "#define ${PROJ}_USE_OPENMP\n")
ENDIF()
IF ( USE_CUDA )
    FILE( APPEND "${TPLs_HEADER}" "#define ${PROJ}_USE_CUDA\n")
    FILE( APPEND "${TPLs_HEADER}" "#define ${PROJ}_USE_DEVICE\n")
ENDIF()
IF ( USE_HIP )
    FILE( APPEND "${TPLs_HEADER}" "#define ${PROJ}_USE_HIP\n")
    FILE( APPEND "${TPLs_HEADER}" "#define ${PROJ}_USE_DEVICE\n")
ENDIF()
IF ( ENABLE_GPU_AWARE_MPI )
    FILE( APPEND "${TPLs_HEADER}" "#define ${PROJ}_ENABLE_GPU_AWARE_MPI\n")
ENDIF()
