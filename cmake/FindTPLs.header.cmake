...
MACRO( ADD_TPL_LIBRARY TPL )
    ...
    IF ( NOT DEFINED ${TPL}_INSTALL_DIR )
        ...
        ELSEIF( DEFINED ${TPL}_INCLUDE_DIRECTORY )
            SET( ${TPL}_INSTALL_DIR "${${TPL}_INCLUDE_DIRECTORY}" )
        ELSEIF( DEFINED ${TPL}_INCLUDE_DIR )
            SET( ${TPL}_INSTALL_DIR "${${TPL}_INCLUDE_DIR}" )
        ELSE()
    ...
    IF ( ${TPL}_INSTALL_DIR )
        ...
        IF ( EXISTS "${${TPL}_INSTALL_DIR}/lib" )
            SET( CMAKE_INSTALL_RPATH ${CMAKE_INSTALL_RPATH} "${${TPL}_INSTALL_DIR}/lib" )
        ELSEIF ( EXISTS "${${TPL}_INSTALL_DIR}/lib64" )
            SET( CMAKE_INSTALL_RPATH ${CMAKE_INSTALL_RPATH} "${${TPL}_INSTALL_DIR}/lib64" )
        ENDIF()
    ENDIF()
ENDMACRO()
