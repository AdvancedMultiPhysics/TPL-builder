...
IF ( NOT TPLs_COMPILERS_INITIALIZED )
    ...
    SET_TPL_VAR( DISABLE_IMPLICIT_LINK      @DISABLE_IMPLICIT_LINK@      )
    ...
    IF ( NOT TPLs_FIND_QUIETLY )
        ...
        MESSAGE( STATUS "CMAKE_Fortran_STANDARD = ${CMAKE_Fortran_STANDARD}")
        IF ( USE_CUDA )
...
IF ( USE_HIP )
    ...
    SET( TPLs_LIBRARIES ${TPLs_LIBRARIES} roc::rocthrust roc::hipblas hip::hiprand hip::hipcub roc::rocrand roc::rocsparse roc::rocblas roc::rocsolver)
    SET( USE_DEVICE TRUE )
ENDIF()
