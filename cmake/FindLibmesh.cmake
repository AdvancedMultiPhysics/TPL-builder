...
#    VERIFY_PATH ( ${LIBMESH_CONTRIB_PATH_LIB} )
    FIND_LIBRARY ( LIBMESH_MESH_LIB     NAMES mesh_dbg  PATHS ${LIBMESH_DIRECTORY}/${CMAKE_INSTALL_LIBDIR}  NO_DEFAULT_PATH )
    FIND_LIBRARY ( LIBMESH_MESH_LIB     NAMES mesh_opt  PATHS ${LIBMESH_DIRECTORY}/${CMAKE_INSTALL_LIBDIR}  NO_DEFAULT_PATH )
    ...
    FIND_LIBRARY ( LIBMESH_NETCDF_LIB   NAMES netcdf    PATHS ${LIBMESH_DIRECTORY}/${CMAKE_INSTALL_LIBDIR}  NO_DEFAULT_PATH )
    IF ( USE_MPI ) 
        FIND_LIBRARY ( LIBMESH_PARMETIS_LIB NAMES parmetis  PATHS ${LIBMESH_CONTRIB_PATH_LIB}  NO_DEFAULT_PATH )
        FIND_LIBRARY ( LIBMESH_MPI_LIB NAMES timpi_opt  PATHS ${LIBMESH_DIRECTORY}/${CMAKE_INSTALL_LIBDIR}  NO_DEFAULT_PATH )
        FIND_LIBRARY ( LIBMESH_MPI_LIB NAMES timpi_dbg  PATHS ${LIBMESH_DIRECTORY}/${CMAKE_INSTALL_LIBDIR}  NO_DEFAULT_PATH )
    ENDIF()
    ...
    IF ( NOT LIBMESH_MESH_LIB )
        MESSAGE ( FATAL_ERROR "Libmesh library (mesh) not found in ${LIBMESH_DIRECTORY}/${CMAKE_INSTALL_LIBDIR}" )
    ENDIF ()
