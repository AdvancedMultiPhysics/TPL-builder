...
# Set CUDA/HIP variables
SET_OPTIONAL( USE_CUDA )
SET_OPTIONAL( CMAKE_CUDA_COMPILER )
SET_OPTIONAL( CMAKE_CUDA_FLAGS )
SET_OPTIONAL( CMAKE_CUDA_ARCHITECTURES )
SET_OPTIONAL( COMPILE_CXX_AS_CUDA )
SET_OPTIONAL( USE_HIP )
SET_OPTIONAL( CMAKE_HIP_COMPILER )
SET_OPTIONAL( CMAKE_HIP_FLAGS )
SET_OPTIONAL( CMAKE_HIP_ARCHITECTURES )
SET_OPTIONAL( NUMBER_OF_GPUS )
SET_OPTIONAL( COMPILE_CXX_AS_HIP )
...
FOREACH ( tpl ${TPL_LIST} )
    ...
    ELSEIF ( ${tpl} STREQUAL "SAMRAI" )
        SET_OPTIONAL( SAMRAI_USE_CUDA )
        SET_OPTIONAL( SAMRAI_USE_OPENMP )
        SET_OPTIONAL( SAMRAI_USE_UMPIRE )
        SET_OPTIONAL( SAMRAI_USE_RAJA )
    ENDIF()
ENDFOREACH()
