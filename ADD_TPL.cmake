...
FUNCTION( ADD_TPL TPL )
    ...
    ENDIF()
    IF ( CMAKE_BUILD_${TPL} )
        # Set the variables that are recognized by EXTERNALPROJECT_ADD
        SET(external_add_one URL GIT_REPOSITORY GIT_TAG DOWNLOAD_DIR SOURCE_DIR BUILD_IN_SOURCE INSTALL_DIR
            TEST_AFTER_INSTALL LOG_DOWNLOAD LOG_UPDATE LOG_CONFIGURE LOG_BUILD LOG_TEST LOG_INSTALL DOWNLOAD_EXTRACT_TIMESTAMP )
        SET(external_add_multiple TARGETS UPDATE_COMMAND PATCH_COMMAND CONFIGURE_COMMAND CMAKE_ARGS PREFIX_PATH BUILD_COMMAND DEPENDS INSTALL_COMMAND TEST_COMMAND )
        ...
        ENDIF()
        # Add prefix paths
        IF ( ADD_TPL_PREFIX_PATH )
            SET( ADD_TPL_CMAKE_ARGS ${ADD_TPL_CMAKE_ARGS} CMAKE_CACHE_ARGS -DCMAKE_PREFIX_PATH:PATH=${ADD_TPL_PREFIX_PATH} )
        ENDIF()
        # Set behavior of file extraction
        IF ( NOT ADD_TPL_DOWNLOAD_EXTRACT_TIMESTAMP )
            SET( ADD_TPL_DOWNLOAD_EXTRACT_TIMESTAMP TRUE )
        ENDIF()
