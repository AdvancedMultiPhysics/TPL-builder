...
CONFIGURE_DEPENDENCIES( SCALAPACK REQUIRED LAPACK )


# Configure scalapack
IF ( CMAKE_BUILD_SCALAPACK )
    SET( SCALAPACK_CONFIGURE_OPTIONS "${CMAKE_ARGS}" )
    SET( SCALAPACK_CONFIGURE_OPTIONS "${SCALAPACK_CONFIGURE_OPTIONS};-DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}" )
    SET( SCALAPACK_CONFIGURE_OPTIONS "${SCALAPACK_CONFIGURE_OPTIONS};-DCMAKE_INSTALL_PREFIX=${SCALAPACK_CMAKE_INSTALL_DIR}" )
    SET( SCALAPACK_CONFIGURE_OPTIONS "${SCALAPACK_CONFIGURE_OPTIONS};-DCMAKE_C_COMPILER=${CMAKE_C_COMPILER}" )
    SET( SCALAPACK_CONFIGURE_OPTIONS "${SCALAPACK_CONFIGURE_OPTIONS};-DCMAKE_Fortran_COMPILER=${CMAKE_Fortran_COMPILER}" )
