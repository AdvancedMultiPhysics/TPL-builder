...
IF ( CMAKE_BUILD_TRILINOS )
    ...
    # Write the TrilinosConfigure.cmake file
    ...
    IF ( HDF5_INSTALL_DIR AND NOT Trilinos_DISABLE_HDF5 )
        ...
        WRITE_TRILINOS_CONFIG( TPL_HDF5_INCLUDE_DIRS "${HDF5_INSTALL_DIR}/include" )
    ELSE()
...
IF ( CMAKE_BUILD_TRILINOS )
    ...
    EXTERNALPROJECT_ADD_STEP(
        TRILINOS
        copy-configure
        COMMAND             ${CMAKE_COMMAND} -E copy_if_different "${TRILINOS_CMAKE_CONFIGURE}" "${TRILINOS_BUILD_DIR}/TrilinosConfigure.cmake"
        COMMENT             ""
        DEPENDEES           download
        DEPENDERS           configure
        LOG                 0
