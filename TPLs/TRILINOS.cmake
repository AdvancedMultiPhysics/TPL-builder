...
IF ( CMAKE_BUILD_TRILINOS )
    ...
    IF ( BOOST_INSTALL_DIR )
        ...
        WRITE_TRILINOS_CONFIG_STRING( Boost_INCLUDE_DIRS "${BOOST_INSTALL_DIR}/include" )
    ELSE()
    ...
    IF ( HDF5_INSTALL_DIR AND NOT Trilinos_DISABLE_HDF5 )
        ...
        WRITE_TRILINOS_CONFIG_STRING( HDF5_LIBRARY_DIRS "${HDF5_INSTALL_DIR}/lib" )
        WRITE_TRILINOS_CONFIG_STRING( HDF5_INCLUDE_DIRS "${HDF5_INSTALL_DIR}/include" )
        WRITE_TRILINOS_CONFIG_STRING( TPL_HDF5_INCLUDE_DIRS "${HDF5_INSTALL_DIR}/include" )
    ELSE()
