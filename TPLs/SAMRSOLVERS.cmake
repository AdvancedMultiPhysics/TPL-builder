...
CONFIGURE_DEPENDENCIES( SAMRSOLVERS REQUIRED SAMRAI AMP OPTIONAL LAPACK ZLIB HYPRE PETSC HDF5 CATCH2 THRUST RAJA KOKKOS UMPIRE )

# Configure SAMRSolvers
IF ( CMAKE_BUILD_SAMRSOLVERS )
    SET( SAMRSOLVERS_CONFIGURE_OPTIONS "${CMAKE_ARGS}" )
    SET( SAMRSOLVERS_CONFIGURE_OPTIONS "${SAMRSOLVERS_CONFIGURE_OPTIONS};-DAMP_DIRECTORY=${AMP_INSTALL_DIR}" )
    ...
    IF ( NOT DEFINED SAMRSOLVERS_DISABLE_KOKKOS )
        SET( SAMRSOLVERS_DISABLE_KOKKOS ${AMP_DISABLE_KOKKOS} )
    ENDIF()
