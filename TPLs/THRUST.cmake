...
IF ( CMAKE_BUILD_THRUST )
    ...
    IF ( THRUST_USE_OPENMP )
        ...
        SET( THRUST_CONFIGURE_OPTIONS ${THRUST_CONFIGURE_OPTIONS} -DTHRUST_HOST_SYSTEM=THRUST_HOST_SYSTEM_OMP )
    ELSE ()
        SET( THRUST_CONFIGURE_OPTIONS ${THRUST_CONFIGURE_OPTIONS} -DTHRUST_HOST_SYSTEM=THRUST_HOST_SYSTEM_CPP )
    ENDIF()
    ...
    IF ( THRUST_USE_CUDA )
        ...
        SET( THRUST_CONFIGURE_OPTIONS ${THRUST_CONFIGURE_OPTIONS} -DTHRUST_DEVICE_SYSTEM=THRUST_DEVICE_SYSTEM_CUDA )
    ELSEIF( THRUST_USE_OPENMP )
        MESSAGE( "Enabling OpenMP support for thrust device system" )
        SET( THRUST_CONFIGURE_OPTIONS ${THRUST_CONFIGURE_OPTIONS} -DTHRUST_DEVICE_SYSTEM=THRUST_DEVICE_SYSTEM_OMP )
    ELSE()
        MESSAGE( "Enabling serial support for thrust device system" )
        SET( THRUST_CONFIGURE_OPTIONS ${THRUST_CONFIGURE_OPTIONS} -DTHRUST_DEVICE_SYSTEM=THRUST_DEVICE_SYSTEM_CPP )
    ENDIF()
...
IF ( EXISTS "${THRUST_INSTALL_DIR}/lib64" )
  SET( THRUST_CMAKE_CONFIG_DIR "${THRUST_INSTALL_DIR}/lib64/cmake/thrust/" )
ELSE()
  SET( THRUST_CMAKE_CONFIG_DIR "${THRUST_INSTALL_DIR}/lib/cmake/thrust/" )
ENDIF()
