...
IF ( PIXIE3D_URL ) 
    MESSAGE("   PIXIE3D_URL = ${PIXIE3D_URL}")
...
ELSEIF ( PIXIE3D_SRC_DIR )
    ...
    MESSAGE("   PIXIE3D_SRC_DIR = ${PIXIE3D_SRC_DIR}"    )
...
MESSAGE( "   PIXIE3D_INSTALL_DIR = ${PIXIE3D_INSTALL_DIR}" )


# Configure optional/required TPLs
CONFIGURE_DEPENDENCIES( PIXIE3D REQUIRED SAMRSOLVERS HDF5 )
