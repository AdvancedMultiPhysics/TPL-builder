...
IF ( CMAKE_BUILD_TIMER )
    ...
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DTIMER_INSTALL_PREFIX=${TIMER_INSTALL_DIR}" )
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    CONFIGURE_TIMER( TRUE \"$\{$\{PROJ}_INSTALL_DIR}/include\" )\n" )
