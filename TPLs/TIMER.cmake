...
IF ( CMAKE_BUILD_TIMER )
    ...
    IF ( DISABLE_GOLD )
        SET( TIMER_CONFIGURE_OPTIONS "${TIMER_CONFIGURE_OPTIONS};-DDISABLE_GOLD=1" )
    ENDIF()
    IF ( TEST_MAX_PROCS )
    ...
    IF( DISABLE_IMPLICIT_LINK )
        SET( TIMER_CONFIGURE_OPTIONS "${TIMER_CONFIGURE_OPTIONS};-DDISABLE_IMPLICIT_LINK=${DISABLE_IMPLICIT_LINK}" )
    ENDIF()
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_PACKAGE( Timer REQUIRED PATHS \"${TIMER_INSTALL_DIR}\" )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_INCLUDE_DIRS $\{TPLs_INCLUDE_DIRS} $\{TIMER_INCLUDE} )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_LIBRARIES Timer::timerutility $\{TPLs_LIBRARIES} )\n" )
