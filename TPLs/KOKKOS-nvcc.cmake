...
STRING( REPLACE "\${NVCC_WRAPPER_DEFAULT_COMPILER:-\"g++\"}" "${KOKKOS_HOST_COMPILER}" NVCC_WRAPPER_CONTENTS "${NVCC_WRAPPER_CONTENTS}")
STRING( REPLACE "nvcc_compiler=nvcc" "nvcc_compiler=${KOKKOS_CUDA_COMPILER}" NVCC_WRAPPER_CONTENTS "${NVCC_WRAPPER_CONTENTS}" )
STRING( REPLACE "cuda_args=\"\"" "cuda_args=\"${KOKKOS_CUDA_CXX_FLAGS}\"" NVCC_WRAPPER_CONTENTS "${NVCC_WRAPPER_CONTENTS}")
