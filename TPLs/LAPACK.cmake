...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    ADD_LIBRARY( LAPACK INTERFACE )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    TARGET_LINK_LIBRARIES( LAPACK INTERFACE $\{LAPACK_LIBS} $\{BLAS_LIBS} $\{BLAS_LAPACK_LINK} )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPL_LIBRARIES LAPACK $\{LAPACK_LIBS} $\{BLAS_LIBS} $\{BLAS_LAPACK_LINK} $\{TPL_LIBRARIES} )\n" )
