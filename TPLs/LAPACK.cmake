...
IF ( CMAKE_BUILD_LAPACK ) 
    ...
    FIND_LIBRARY( BLAS_LIBRARY    NAMES blas    PATHS "${LAPACK_INSTALL_DIR}/lib"  NO_DEFAULT_PATH )
    FIND_LIBRARY( LAPACK_LIBRARY  NAMES lapack  PATHS "${LAPACK_INSTALL_DIR}/lib"  NO_DEFAULT_PATH )
    MESSAGE( "LAPACK_LIBRARY ${LAPACK_LIBRARY}")
    SET( BLAS_DIR   "${LAPACK_INSTALL_DIR}/lib" )
    SET( LAPACK_DIR "${LAPACK_INSTALL_DIR}/lib" )
    IF ( ENABLE_SHARED )
        SET( BLAS_LIBS   "${LAPACK_INSTALL_DIR}/lib/libblas.so" )
        SET( LAPACK_LIBS "${LAPACK_INSTALL_DIR}/lib/liblapack.so" )
    ELSE()
