...
IF ( CMAKE_BUILD_SAMRAI )
    ...
    IF ( SAMRAI_USE_UMPIRE )
        ...
        SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS} -Dumpire_DIR=${umpire_DIR} )
    ELSE()
    ...
    IF ( SAMRAI_USE_UMPIRE AND SAMRAI_USE_RAJA )
        ...
        FIND_PACKAGE( RAJA REQUIRED PATHS ${RAJA_INSTALL_DIR}  )
        SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS} -DENABLE_RAJA=ON  )
        SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS} -DRAJA_DIR=${RAJA_DIR} )
    ELSE()
