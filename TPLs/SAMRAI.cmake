...
ENDIF()
IF ( NOT DEFINED SAMRAI_USE_HDF5 )
	SET( SAMRAI_USE_HDF5 ${USE_HDF5} )
ENDIF()
...
IF ( CMAKE_BUILD_SAMRAI )
    ...
    SET( SAMRAI_DEPENDS LAPACK ZLIB )
    IF ( SAMRAI_USE_CUDA )
...
#        SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS}  -Dumpire_DIR=${UMPIRE_INSTALL_DIR}/share/umpire/cmake )
        SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS}  -Dumpire_DIR=${UMPIRE_INSTALL_DIR}/lib/cmake/umpire )
    ELSE()
...
#        SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS}  -DRAJA_DIR=${RAJA_INSTALL_DIR}/share/raja/cmake )
