...
IF ( CMAKE_BUILD_SAMRAI )
    ...
    IF ( SAMRAI_USE_UMPIRE )
        ...
        FILE( REAL_PATH ${UMPIRE_INSTALL_DIR} UMPIRE_REAL_PATH )
        IF ( EXISTS ${UMPIRE_REAL_PATH}/lib/cmake/umpire )
          SET( UMPIRE_CONF_PATH ${UMPIRE_INSTALL_DIR}/lib/cmake/umpire )
        ENDIF()
        IF ( EXISTS ${UMPIRE_REAL_PATH}/lib64/cmake/umpire )
          SET( UMPIRE_CONF_PATH ${UMPIRE_INSTALL_DIR}/lib64/cmake/umpire )
        ENDIF()
        MESSAGE( "UMPIRE_CONF_PATH is " ${UMPIRE_CONF_PATH} )
        SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS} -Dumpire_DIR=${UMPIRE_CONF_PATH} )
    ELSE()
    ...
    IF ( SAMRAI_USE_UMPIRE AND SAMRAI_USE_RAJA )
        ...
        FILE( REAL_PATH ${RAJA_INSTALL_DIR} RAJA_REAL_PATH )
        MESSAGE( "RAJA_INSTALL_DIR " ${RAJA_INSTALL_DIR} )
        IF ( EXISTS ${RAJA_REAL_PATH} )
          MESSAGE( "${RAJA_REAL_PATH}" exists )
        ENDIF()
        IF ( EXISTS ${RAJA_REAL_PATH}/lib )
          MESSAGE( "${RAJA_REAL_PATH}/lib " exists )
        ENDIF()
        IF ( EXISTS ${RAJA_REAL_PATH}/lib/cmake )
          MESSAGE( "${RAJA_REAL_PATH}/lib/cmake " exists )
        ENDIF()
        IF ( EXISTS ${RAJA_REAL_PATH}/lib/cmake/raja )
          MESSAGE( "${RAJA_REAL_PATH}/lib/cmake/raja " exists )
        ENDIF()
        IF ( EXISTS ${RAJA_REAL_PATH}/lib/cmake/raja )
          SET( RAJA_CONF_PATH ${RAJA_INSTALL_DIR}/lib/cmake/raja)
        ENDIF()
        IF ( EXISTS ${RAJA_REAL_PATH}/lib64/cmake/raja )
          SET( RAJA_CONF_PATH ${RAJA_INSTALL_DIR}/lib64/cmake/raja )
        ENDIF()
        MESSAGE( "RAJA_CONF_PATH is " ${RAJA_CONF_PATH} )
        SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS} -DRAJA_DIR=${RAJA_CONF_PATH} )
    ELSE()
