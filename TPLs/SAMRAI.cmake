...
IF ( CMAKE_BUILD_SAMRAI )
    ...
    IF ( SAMRAI_USE_UMPIRE )
        ...
        IF ( IS_DIRECTORY ${UMPIRE_INSTALL_DIR}/lib/cmake/umpire )
          SET( UMPIRE_CONF_PATH "${UMPIRE_INSTALL_DIR}/lib/cmake/umpire")
        ENDIF()
        IF ( IS_DIRECTORY ${UMPIRE_INSTALL_DIR}/lib64/cmake/umpire )
          SET( UMPIRE_CONF_PATH "${UMPIRE_INSTALL_DIR}/lib/cmake/umpire")
        ENDIF()
    ...
    IF ( SAMRAI_USE_UMPIRE AND SAMRAI_USE_RAJA )
        ...
        IF ( IS_DIRECTORY ${RAJA_INSTALL_DIR}/lib/cmake/raja )
          SET( RAJA_CONF_PATH "${RAJA_INSTALL_DIR}/lib/cmake/raja")
        ENDIF()
        IF ( IS_DIRECTORY ${RAJA_INSTALL_DIR}/lib64/cmake/raja )
          SET( RAJA_CONF_PATH "${RAJA_INSTALL_DIR}/lib/cmake/raja")
        ENDIF()
    ...
    ENDIF()
#    SET( SAMRAI_CONFIGURE_OPTIONS ${SAMRAI_CONFIGURE_OPTIONS}  -DCMAKE_PREFIX_PATH=${SAMRAI_CMAKE_PREFIX_PATH}  )
    IF ( USE_MPI )
