...
IF ( CMAKE_BUILD_SAMRUTILS )
    ...
    IF ( USE_MPI_FOR_SERIAL_TESTS ) 
        SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DUSE_MPI_FOR_SERIAL_TESTS=${USE_MPI_FOR_SERIAL_TESTS}" )
    ENDIF()
    IF ( MPIEXEC_NUMPROC_FLAG ) 
        SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DMPIEXEC_NUMPROC_FLAG=${MPIEXEC_NUMPROC_FLAG}" )
    ENDIF()
    IF ( MPIEXEC ) 
        SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DMPIEXEC=${MPIEXEC}" )
    ENDIF()
    IF ( MPI_COMPILER ) 
        SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DMPI_COMPILER=${MPI_COMPILER}" )
    ENDIF()
ENDIF()
