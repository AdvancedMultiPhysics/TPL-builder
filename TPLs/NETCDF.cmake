...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_LIBRARY( NETCDF_HDF5_LIB      NAMES hdf5      PATHS $\{NETCDF_DIRECTORY}/lib  NO_DEFAULT_PATH )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_LIBRARY( NETCDF_HL_LIB        NAMES hl        PATHS $\{NETCDF_DIRECTORY}/lib  NO_DEFAULT_PATH )\n" )
