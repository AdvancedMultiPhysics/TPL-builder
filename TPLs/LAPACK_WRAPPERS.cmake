...
IF ( CMAKE_BUILD_LAPACK_WRAPPERS )
    ...
    IF ( DISABLE_GOLD )
        SET( LAPACK_WRAPPERS_OPTIONS "${LAPACK_WRAPPERS_OPTIONS};-DDISABLE_GOLD=1" )
    ENDIF()
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_PACKAGE( LapackWrappers REQUIRED PATHS \"${LAPACK_WRAPPERS_INSTALL_DIR}\" )\n" )
