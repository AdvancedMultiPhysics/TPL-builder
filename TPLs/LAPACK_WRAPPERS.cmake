...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPL_LIBRARIES LapackWrappers::LapackWrappers $\{TPL_LIBRARIES} )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_LAPACK_WRAPPERS_FOUND TRUE )\n" )
