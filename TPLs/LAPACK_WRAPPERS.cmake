...
CONFIGURE_DEPENDENCIES( LAPACK_WRAPPERS OPTIONAL LAPACK OPENBLAS )


# Create the LAPACK_WRAPPERS target
...
ELSE()
    ADD_TPL_EMPTY( LAPACK_WRAPPERS )
ENDIF()


# Add the appropriate fields to FindTPLs.cmake
FILE( APPEND "${FIND_TPLS_CMAKE}" "\n# Find LAPACK_WRAPPERS\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "IF ( TPLs_FIND_LAPACK_WRAPPERS AND NOT TPLs_LAPACK_WRAPPERS_FOUND )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_PACKAGE( LapackWrappers REQUIRED PATHS \"${LAPACK_WRAPPERS_INSTALL_DIR}/lib/cmake\" )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( LAPACK_WRAPPERS_INSTALL_DIR \"${LAPACK_WRAPPERS_INSTALL_DIR}\" )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( LAPACK_WRAPPERS_INCLUDE_DIR \"${LAPACK_WRAPPERS_INSTALL_DIR}/include\" )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    ADD_TPL_LIBRARY( LAPACK_WRAPPERS LapackWrappers::LapackWrappers )\n" )
