...
IF ( CMAKE_BUILD_STACKTRACE )
    ...
    IF ( DISABLE_GOLD )
        SET( STACKTRACE_CONFIGURE_OPTIONS "${STACKTRACE_CONFIGURE_OPTIONS};-DDISABLE_GOLD=1" )
    ENDIF()
    IF ( USE_MPI )
        ...
        ENDIF()
    ELSE()
        SET( STACKTRACE_CONFIGURE_OPTIONS "${STACKTRACE_CONFIGURE_OPTIONS};-DUSE_MPI:BOOL=FALSE" )
    ENDIF()
    ...
    ENDIF()
    MESSAGE( "   STACKTRACE configure options: ${STACKTRACE_CONFIGURE_OPTIONS}" )
    ADD_TPL(
        STACKTRACE
...
ELSE()
    ADD_TPL_EMPTY( STACKTRACE )
ENDIF()


# Add the appropriate fields to FindTPLs.cmake
FILE( APPEND "${FIND_TPLS_CMAKE}" "\n# Find STACKTRACE\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "IF ( TPLs_FIND_STACKTRACE AND NOT TPLs_STACKTRACE_FOUND )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_PACKAGE( StackTrace REQUIRED PATHS \"${STACKTRACE_INSTALL_DIR}\" )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    ADD_TPL_LIBRARY( STACKTRACE StackTrace::stacktrace )\n" )
