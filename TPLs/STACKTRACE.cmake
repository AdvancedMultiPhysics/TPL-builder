...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_PACKAGE( StackTrace REQUIRED PATHS \"${STACKTRACE_INSTALL_DIR}/lib/cmake\" )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_LIBRARIES StackTrace::stacktrace $\{TPLs_LIBRARIES} )\n" )
