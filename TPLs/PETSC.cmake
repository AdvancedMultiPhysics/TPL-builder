...
CONFIGURE_DEPENDENCIES( SAMRAI REQUIRED LAPACK )
...
ENDIF()
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( CMAKE_INSTALL_RPATH $\{CMAKE_INSTALL_RPATH} \"${PETSC_INSTALL_DIR}/lib\" )\n" )
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_PETSC_FOUND TRUE )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "ENDIF()\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "\n" )
