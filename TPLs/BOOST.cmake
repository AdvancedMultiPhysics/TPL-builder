...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_INCLUDE_DIRS  $\{TPLs_INCLUDE_DIRS} $\{Boost_INCLUDE_DIRS} )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_LIBRARIES $\{TPLs_LIBRARIES} $\{Boost_LIBRARIES} )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_BOOST_FOUND TRUE )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "ENDIF()\n" )
