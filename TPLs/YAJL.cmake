...
ELSEIF ( YAJL_SRC_DIR )
    ...
    MESSAGE_TPL("   YAJL_SRC_DIR = ${YAJL_SRC_DIR}")
    SET( YAJL_CMAKE_URL            ""                  )
...
MESSAGE_TPL( "   YAJL_INSTALL_DIR = ${YAJL_INSTALL_DIR}" )
FILE( APPEND "${CMAKE_INSTALL_PREFIX}/TPLs.cmake" "SET(YAJL_INSTALL_DIR \"${YAJL_INSTALL_DIR}\")\n" )
