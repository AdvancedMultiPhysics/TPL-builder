...
FILE( MAKE_DIRECTORY ${MATLAB_BUILD_DIR} )
...
SET( MATLAB_BLAS_LIBRARY MATLAB_BLAS_LIBRARY-NOTFOUND )
SET( MATLAB_LAPACK_LIBRARY MATLAB_LAPACK_LIBRARY-NOTFOUND )
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "IF ( TPLs_FIND_MATLAB AND NOT TPLs_MATLAB_FOUND )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_MATLAB_FOUND TRUE )\n")
