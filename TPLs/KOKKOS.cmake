...
IF ( CMAKE_BUILD_KOKKOS )
    ...
    SET( KOKKOS_CONFIGURE_OPTIONS ${KOKKOS_CONFIGURE_OPTIONS} -DKokkos_ENABLE_SERIAL=ON -DKokkos_ENABLE_OPENMP=ON )
    ...
    IF ( CUDA_INSTALL )
        ...
        SET( KOKKOS_CONFIGURE_OPTIONS ${KOKKOS_CONFIGURE_OPTIONS} --compiler=${CMAKE_INSTALL_PREFIX}/kokkos/nvcc_wrapper )
        SET( KOKKOS_CONFIGURE_OPTIONS ${KOKKOS_CONFIGURE_OPTIONS} --with-openmp --with-serial )
#        SET( KOKKOS_CONFIGURE_OPTIONS ${KOKKOS_CONFIGURE_OPTIONS} --with-pthread --with-openmp --with-serial )
        SET( KOKKOS_CONFIGURE_OPTIONS ${KOKKOS_CONFIGURE_OPTIONS} --with-cuda=${CUDA_INSTALL} )
