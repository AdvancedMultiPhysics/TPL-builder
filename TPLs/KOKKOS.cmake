...
IF ( KOKKOS_URL ) 
    MESSAGE(FATAL_ERROR "KOKKOS_URL is not currently supported, please use KOKKOS_SRC_DIR")
...
IF ( CMAKE_BUILD_KOKKOS )
    ...
    IF ( USE_CUDA )
        ...
        SET( NVCC_WRAPPER_TMP "${CMAKE_BINARY_DIR}/KOKKOS-prefix/src/KOKKOS-build/tmp/nvcc_wrapper" )
        SET( NVCC_WRAPPER_OUT "${CMAKE_BINARY_DIR}/KOKKOS-prefix/src/KOKKOS-build/nvcc_wrapper" )
        FILE(WRITE "${NVCC_WRAPPER_TMP}" "${NVCC_WRAPPER_CONTENTS}")
        FILE(COPY "${NVCC_WRAPPER_TMP}" DESTINATION "${CMAKE_BINARY_DIR}/KOKKOS-prefix/src/KOKKOS-build"
        ...
        FILE( APPEND "${CMAKE_INSTALL_PREFIX}/kokkos/KOKKOS.cmake" "SET( KOKKOS_COMPILER \"${NVCC_WRAPPER_OUT}\" )\n" )
...
#        CONFIGURE_COMMAND   ${KOKKOS_CMAKE_SOURCE_DIR}/generate_makefile.bash ${KOKKOS_CONFIGURE_OPTIONS}
