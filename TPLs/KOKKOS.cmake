...
IF ( CMAKE_BUILD_KOKKOS )
    ...
    IF ( CUDA_INSTALL )
        ...
        SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-openmp --with-serial )
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_LIBRARY( KOKKOS_LIB  NAMES kokkoscore  PATHS \"$\{KOKKOS_DIRECTORY}/lib\"  NO_DEFAULT_PATH )\n" )
