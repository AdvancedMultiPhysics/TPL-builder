...
ELSEIF ( HPL_SRC_DIR )
    ...
    MESSAGE_TPL("   HPL_SRC_DIR = ${HPL_SRC_DIR}" )
    SET( HPL_CMAKE_URL            ""                  )
...
MESSAGE_TPL( "   HPL_INSTALL_DIR = ${HPL_INSTALL_DIR}" )
FILE( APPEND "${CMAKE_INSTALL_PREFIX}/TPLs.cmake" "SET(HPL_INSTALL_DIR \"${HPL_INSTALL_DIR}\")\n" )
FILE( APPEND "${CMAKE_INSTALL_PREFIX}/TPLs.cmake" "SET(HPL_HOST_TYPE ${HPL_HOSTTYPE} )\n" )
FILE( APPEND "${CMAKE_INSTALL_PREFIX}/TPLs.cmake" "SET(HPL_COMPILE_TYPE ${HPL_METHOD} )\n" )
