...
IF ( CMAKE_BUILD_LIBMESH )
    ...
    IF ( METIS_CONFIGURED )
        MESSAGE( FATAL_ERROR, "Libmesh configure with external metis not implemented as yet" )
    ELSE()
        SET( LIBMESH_CONFIGURE_OPTIONS ${LIBMESH_CONFIGURE_OPTIONS} --enable-metis      )
    ENDIF()
    IF ( PARMETIS_CONFIGURED )
        MESSAGE( FATAL_ERROR, "Libmesh configure with external parmetis not implemented as yet" )
    ELSE()
