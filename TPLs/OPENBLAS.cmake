...
IF ( CMAKE_BUILD_OPENBLAS )
    EXTERNALPROJECT_ADD(
        ...
        UPDATE_COMMAND      ""
        CONFIGURE_COMMAND   ""
        BUILD_COMMAND       make -j ${PROCS_INSTALL} ${OPENBLAS_ENV_VARS} VERBOSE=1
        BUILD_IN_SOURCE     1
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "IF ( TPLs_FIND_OPENBLAS AND NOT TPL_FOUND_OPENBLAS )\n" )
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPL_FOUND_OPENBLAS TRUE )\n" )
