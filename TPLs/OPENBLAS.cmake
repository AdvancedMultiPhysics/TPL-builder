...
IF ( CMAKE_BUILD_OPENBLAS )
    SET( CONFIGURE_OPTIONS "${CMAKE_ARGS}" -DCMAKE_INSTALL_PREFIX=${OPENBLAS_CMAKE_INSTALL_DIR} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} )
    IF ( ENABLE_SHARED )
...
ADD_TPL(
    ...
    BUILD_COMMAND       ${CMAKE_MAKE_PROGRAM} -j ${PROCS_INSTALL} ${OPENBLAS_ENV_VARS} VERBOSE=1
    BUILD_IN_SOURCE     0
