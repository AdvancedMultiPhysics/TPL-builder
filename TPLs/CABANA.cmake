...
IF ( CMAKE_BUILD_CABANA )
    ...
    ENDIF()
    SET( CABANA_CONFIGURE_OPTS ${CABANA_CONFIGURE_OPTS} -DKokkos_DIR=${KOKKOS_INSTALL_DIR} )
    ...
    SET( CABANA_CONFIGURE_OPTS ${CABANA_CONFIGURE_OPTS} -D Cabana_ENABLE_CAJITA=ON )
    IF ( CABANA_TEST )
