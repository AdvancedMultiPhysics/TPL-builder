...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_PACKAGE( Catch2 REQUIRED PATHS \"${CATCH2_INSTALL_DIR}/${CMAKE_INSTALL_LIBDIR}/cmake/Catch2\" )\n" )
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_CATCH2_FOUND TRUE )\n" )
