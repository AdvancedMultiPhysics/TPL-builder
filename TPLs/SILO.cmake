...
IF ( CMAKE_BUILD_SILO )
    ...
    FIND_LIBRARY( HDF5_LIB NAMES hdf5 PATHS ${HDF5_INSTALL_DIR}/lib ${HDF5_INSTALL_DIR}/lib64 NO_DEFAULT_PATH )
    GET_FILENAME_COMPONENT( HDF5_PATH ${HDF5_LIB} PATH )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-hdf5=${HDF5_INSTALL_DIR}/include,${HDF5_PATH} )
MESSAGE( "HDF5_LIB=${HDF5_LIB}" )
MESSAGE( "HDF5_PATH=${HDF5_PATH}" )
MESSAGE( "CONFIGURE_OPTIONS=${CONFIGURE_OPTIONS}" )

    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-zlib=${ZLIB_INSTALL_DIR}/include,${ZLIB_INSTALL_DIR}/lib )
