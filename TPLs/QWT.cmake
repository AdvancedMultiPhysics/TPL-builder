...
FILE( APPEND "${FIND_TPLS_CMAKE}" "IF ( TPLs_FIND_QWT AND NOT TPL_FOUND_QWT )\n" )
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    FIND_LIBRARY( QWT_LIB  NAMES qwt  PATHS \"${QWT_INSTALL_DIR}/lib\" \"${QWT_INSTALL_DIR}/lib64\" NO_DEFAULT_PATH )\n" )
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPL_FOUND_QWT TRUE )\n" )
