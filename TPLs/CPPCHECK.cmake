...
IF (CMAKE_BUILD_CPPCHECK )
    SET( CONFIGURE_OPTIONS -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_BUILD_TYPE=Release )
    IF ( USING_ICC )
       SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} -DCMAKE_CXX_FLAGS=-D_GLIBCXX_USE_CXX11_ABI=0 )
    ENDIF()
    MESSAGE( "Configuring cppcheck with ${CONFIGURE_OPTIONS}")
ENDIF()
...
ADD_TPL(
    ...
    CMAKE_ARGS          ${CONFIGURE_OPTIONS}  -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}/cppcheck
