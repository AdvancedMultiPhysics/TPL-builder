...
IF ( CMAKE_BUILD_CPPCHECK )
    ...
    ENDIF()
    SET( CPPCHECK_CONFIGURE_OPTIONS ${CPPCHECK_CONFIGURE_OPTIONS} -DUSE_MATCHCOMPILER=On )
    ...
    ADD_TPL(
        ...
        BUILD_COMMAND       $(MAKE) MATCHCOMPILER=yes install VERBOSE=1
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "IF ( TPLs_FIND_CPPCHECK AND NOT TPLs_CPPCHECK_FOUND )\n" )
...
FILE( APPEND "${FIND_TPLS_CMAKE}" "    SET( TPLs_CPPCHECK_FOUND TRUE )\n" )
