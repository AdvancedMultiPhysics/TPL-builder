...
# User can configure the source path by speficfying NRDF_SRC_DIR,
...
ELSEIF ( NRDF_SRC_DIR )
    ...
    MESSAGE_TPL("   NRDF_SRC_DIR = ${NRDF_SRC_DIR}")
    SET( NRDF_CMAKE_URL            ""                  )
...
MESSAGE_TPL( "   NRDF_INSTALL_DIR = ${NRDF_INSTALL_DIR}" )
FILE( APPEND "${CMAKE_INSTALL_PREFIX}/TPLs.cmake" "SET(NRDF_INSTALL_DIR \"${NRDF_INSTALL_DIR}\")\n" )
