...
IF ( CMAKE_BUILD_XBRAID )
    ...
    IF ( ${CMAKE_BUILD_TYPE} STREQUAL "Debug" )
        SET( CONFIGURE_OPTIONS debug=yes )
    ELSEIF ( ${CMAKE_BUILD_TYPE} STREQUAL "Release" )
        SET( CONFIGURE_OPTIONS debug=no )
    ELSE()
    ...
    EXTERNALPROJECT_ADD_STEP(
        ...
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/_braid.h" "${XBRAID_INSTALL_DIR}/include"
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/braid.h" "${XBRAID_INSTALL_DIR}/include"
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/braid_status.h" "${XBRAID_INSTALL_DIR}/include"
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/braid_test.h" "${XBRAID_INSTALL_DIR}/include"
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/mpistubs.h" "${XBRAID_INSTALL_DIR}/include"
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/status.h" "${XBRAID_INSTALL_DIR}/include"
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/tape.h" "${XBRAID_INSTALL_DIR}/include"
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/util.h" "${XBRAID_INSTALL_DIR}/include"
        COMMAND             ${CMAKE_COMMAND} -E copy "${XBRAID_CMAKE_SOURCE_DIR}/braid/braid.hpp" "${XBRAID_INSTALL_DIR}/include"
        COMMENT             ""
    	DEPENDEES           install
