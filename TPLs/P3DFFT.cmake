...
CONFIGURE_DEPENDENCIES( P2DFFT REQUIRED FFTW )


# Configure p3dfft
IF ( CMAKE_BUILD_P3DFFT )
    SET( P3DFFT_CONFIGURE_OPTIONS )
    SET( P3DFFT_LD_FLAGS )
    SET( P3DFFT_LIBS )
    SET( P3DFFT_CONFIGURE_OPTIONS ${P3DFFT_CONFIGURE_OPTIONS} --prefix=${CMAKE_INSTALL_PREFIX}/p3dfft )
    SET( P3DFFT_CONFIGURE_OPTIONS ${P3DFFT_CONFIGURE_OPTIONS} --enable-fftw )
    SET( P3DFFT_CONFIGURE_OPTIONS ${P3DFFT_CONFIGURE_OPTIONS} --with-fftw=${CMAKE_INSTALL_PREFIX}/fftw )
    IF( CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX )
        SET( P3DFFT_CONFIGURE_OPTIONS ${P3DFFT_CONFIGURE_OPTIONS} --enable-gcc )
    ...
    ELSEIF( (${CMAKE_C_COMPILER_ID} MATCHES "Intel") OR (${CMAKE_CXX_COMPILER_ID} MATCHES "Intel") OR
        ...
        SET( P3DFFT_CONFIGURE_OPTIONS ${P3DFFT_CONFIGURE_OPTIONS} --enable-intel )
    ELSEIF( (${CMAKE_C_COMPILER_ID} MATCHES "PGI") OR (${CMAKE_CXX_COMPILER_ID} MATCHES "PGI") )
        SET( P3DFFT_CONFIGURE_OPTIONS ${P3DFFT_CONFIGURE_OPTIONS} --enable-pgi )
    ELSE()
...
IF ( CMAKE_BUILD_P3DFFT )
    EXTERNALPROJECT_ADD( 
        ...
        UPDATE_COMMAND      ""
        CONFIGURE_COMMAND   ${P3DFFT_CMAKE_SOURCE_DIR}/configure ${P3DFFT_CONFIGURE_OPTIONS} CXXFLAGS=${P3DFFT_CXX_FLAGS} LDFLAGS=${P3DFFT_LD_FLAGS} LIBS=${P3DFFT_LIBS}
