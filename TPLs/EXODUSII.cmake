...
IF ( CMAKE_BUILD_EXODUSII )
    ...
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DHDF5HL_LIBRARY=${CMAKE_INSTALL_PREFIX}/hdf5/lib/libhdf5_hl.a" )
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DHDF5_LIBRARY=${CMAKE_INSTALL_PREFIX}/hdf5/lib/libhdf5.a" )
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DNETCDF_INCLUDE_DIR:PATH=${CMAKE_INSTALL_PREFIX}/netcdf/include" )
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DNETCDF_LIBRARY=${CMAKE_INSTALL_PREFIX}/netcdf/lib/libnetcdf.a" )
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DNETCDF_NCDUMP=${CMAKE_INSTALL_PREFIX}/netcdf/bin/ncdump" )
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DZ_LIBRARY:PATH=${CMAKE_INSTALL_PREFIX}/zlib/lib/libz.a" )
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DCMAKE_C_STANDARD_LIBRARIES=${CMAKE_INSTALL_PREFIX}/zlib/lib/libz.a" )
    SET( CONFIGURE_OPTIONS "${CONFIGURE_OPTIONS};-DCMAKE_CXX_STANDARD_LIBRARIES=${CMAKE_INSTALL_PREFIX}/zlib/lib/libz.a" )
ENDIF()
