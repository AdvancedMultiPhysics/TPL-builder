...
IF ( CMAKE_BUILD_HYPRE )
    IF( HYPRE_USE_CUDA )
        ...
        IF ( HYPRE_USE_UMPIRE )
            ...
            SET( HYPRE_CONFIGURE_OPTIONS ${HYPRE_CONFIGURE_OPTIONS} --with-umpire --with-umpire-include=${UMPIRE_INSTALL_DIR}/include --with-umpire-lib-dirs=${UMPIRE_INSTALL_DIR}/${CMAKE_INSTALL_LIBDIR} --with-umpire-libs=umpire )
