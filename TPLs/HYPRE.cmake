...
IF ( CMAKE_BUILD_HYPRE )
    ...
    IF ( HYPRE_USE_UMPIRE )
         ...
         SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-umpire --with-umpire-um --with-umpire-include=${UMPIRE_INSTALL_DIR}/include --with-umpire-lib-dirs=${UMPIRE_INSTALL_DIR}/lib --with-umpire-libs=umpire )
    ELSE()
