...
IF ( CMAKE_BUILD_HYPRE )
    ...
    IF( HYPRE_USE_HIP )
        ...
        IF ( HYPRE_HIP_HOME )
            ADD_HYPRE_OPTION( -with-hip --with-hip-home=${HYPRE_HIP_HOME} )
        ELSE()
            ADD_HYPRE_OPTION( -with-hip --with-hip-home=${HIP_HOME} )
        ENDIF()
        IF ( HYPRE_HIP_ARCH )
        ...
        ADD_HYPRE_OPTION( --enable-unified-memory --with-extra-CUFLAGS=${CMAKE_HIP_FLAGS} )
    ENDIF()
    ...
    ELSEIF ( (${CMAKE_BUID_TYPE} STREQUAL "Release") OR (${CMAKE_BUILD_TYPE} STREQUAL "RelWithDebInfo") )
    ...
    FILE( APPEND "${HYPRE_CONFIG}" "    LIST( POP_BACK tmp2 val )\n" )
