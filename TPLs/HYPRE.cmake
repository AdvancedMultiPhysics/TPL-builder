...
IF ( CMAKE_BUILD_HYPRE )
    ...
    IF ( ( HYPRE_USE_CUDA OR HYPRE_USE_HIP ) AND HYPRE_USE_UMPIRE )
      ...
      ENDIF()
      SET( HYPRE_CONFIGURE_OPTIONS ${HYPRE_CONFIGURE_OPTIONS} --with-umpire --with-umpire-include=${UMPIRE_INSTALL_DIR}/include --with-umpire-lib-dirs=${UMPIRE_DIR_PATH} --with-umpire-libs=umpire )
