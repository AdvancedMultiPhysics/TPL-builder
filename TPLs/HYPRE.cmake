...
IF ( CMAKE_BUILD_HYPRE )
    ...
    IF ( ( HYPRE_USE_CUDA OR HYPRE_USE_HIP ) AND HYPRE_USE_UMPIRE )
      ...
      FIND_PACKAGE( umpire REQUIRED PATHS ${UMPIRE_INSTALL_DIR}  )
      SET ( UMPIRE_LIB_PATH )
      IF ( IS_DIRECTORY ${UMPIRE_INSTALL_DIR}/lib )
        SET( UMPIRE_LIB_PATH "${UMPIRE_INSTALL_DIR}/lib" )
      ENDIF()
      IF ( IS_DIRECTORY ${UMPIRE_INSTALL_DIR}/lib64 )
        SET( UMPIRE_LIB_PATH "${UMPIRE_INSTALL_DIR}/lib64" )
      ENDIF()
      SET( HYPRE_CONFIGURE_OPTIONS ${HYPRE_CONFIGURE_OPTIONS} --with-umpire --with-umpire-include=${UMPIRE_INSTALL_DIR}/include --with-umpire-lib-dirs=${UMPIRE_LIB_PATH} --with-umpire-libs=umpire )
