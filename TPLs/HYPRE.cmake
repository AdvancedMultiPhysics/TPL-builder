...
IF ( CMAKE_BUILD_HYPRE )
    ...
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-blas-lib-dirs=${CMAKE_INSTALL_PREFIX}/lapack/lib )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-lapack-libs=${LAPACK_LIBRARY} )
    SET( CONFIGURE_OPTIONS ${CONFIGURE_OPTIONS} --with-lapack-lib-dirs=${CMAKE_INSTALL_PREFIX}/lapack/lib )
