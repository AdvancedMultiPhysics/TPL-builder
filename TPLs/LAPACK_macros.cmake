...
FUNCTION( CHECK_MKL INSTALL_PATH CMAKE_FILE )
    ...
    IF ( ENABLE_STATIC ) 
        ...
        FIND_LIBRARY( MKL_RT      NAMES mkl_rt.lib              PATHS "${MKL_LIB_PATH}"  NO_DEFAULT_PATH )
    ...
    ELSEIF( ENABLE_SHARED ) 
        ...
        FIND_LIBRARY( MKL_RT      NAMES mkl_rt_dll.lib     PATHS "${MKL_LIB_PATH}"  NO_DEFAULT_PATH )
