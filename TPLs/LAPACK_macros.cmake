...
FUNCTION( CHECK_MKL INSTALL_PATH CMAKE_FILE )
    VERIFY_PATH( "${INSTALL_PATH}" )
    SET( MKL_INCLUDE_PATH "${INSTALL_PATH}" )
    SET( MKL_LIB_PATH "${INSTALL_PATH}" )
    IF ( EXISTS "${INSTALL_PATH}/include" )
        SET( MKL_INCLUDE_PATH "${INSTALL_PATH}/include" )
    ENDIF()
    IF ( EXISTS "${INSTALL_PATH}/lib" )
        SET( MKL_LIB_PATH "${INSTALL_PATH}/lib" )
    ENDIF()
    IF ( EXISTS "${MKL_LIB_PATH}/intel64" )
        SET( MKL_LIB_PATH "${MKL_LIB_PATH}/intel64" )
    ENDIF()
    IF ( ENABLE_STATIC ) 
    ...
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#include \"${MKL_INCLUDE_PATH}/mkl_blas.h\"\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#include \"${MKL_INCLUDE_PATH}/mkl_lapack.h\"\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#ifndef USE_BLAS\n #define USE_BLAS\n #endif\n" )
    FILE( APPEND "${BLAS_LAPACK_HEADER}" "#ifndef USE_LAPACK\n #define USE_LAPACK\n #endif\n" )
