...
FUNCTION( CHECK_ACML INSTALL_PATH CMAKE_FILE )
    ...
    SET( BLAS_LIBS   "${ACML_LIBRARY}" "${ACML_MV_LIBRARY}" PARENT_SCOPE )
    SET( LAPACK_LIBS "${ACML_LIBRARY}" "${ACML_MV_LIBRARY}" PARENT_SCOPE )
    SET( BLAS_LAPACK_LINK "-Wl,${ACML_LIBRARY}" "-Wl,${ACML_MV_LIBRARY}" PARENT_SCOPE )
